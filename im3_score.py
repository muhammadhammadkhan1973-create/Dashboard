...
def score_ticker(ticker):
    ...
    # an inflecting winner is no longer marked down as a likely fraud. A plausible value on a NON-inflecting
    # name still scores normally, preserving the genuine red-flag signal.
