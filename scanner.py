...
EXPLOSIVE_CACHE_SCHEMA      = 'sec2'  # v1.161.1: bump sec1->sec2 -> one re-fetch so v1.161.0's net-income gate + [EXPL SEC-diag] actually run (v1.160.0's warm 'sec1' cache was suppressing them: 198 hit/0 fetched)
