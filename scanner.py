...
DATA_SOURCE_PROBE = True  # one-run armed: dump which feeds carry NDX/DJI/RUT, Arab Light/Dubai crude, and what FMP /stable/ serves — then lock + flip False
