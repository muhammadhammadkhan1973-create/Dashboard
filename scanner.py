...
_HYDROGEN_WATCH = [
    ...
    {'rank': 4, 'name': 'iShares Energy Storage & Hydrogen UCITS ETF USD (Acc)', 'isin': 'IE000DR59CI3',
     'ter': 0.40, 'size_m_eur': 49, 'ticker_lse': None, 'ret_6m': None, 'ret_1y': None,
     'holdings': 'Linde, Air Liquide, Plug Power, Nel, Ballard',
     'note': 'added 2026-07-02 -- found missing from the prior 4-fund list; no seed 6M/1Y available yet, live_ytd/live_ret_1y will populate from the next run\u2019s resolver like every other fund on this tab'},
