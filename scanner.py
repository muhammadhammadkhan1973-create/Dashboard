        ...
        def _lookback(days, min_fallback_days=None):
            ...
            if min_fallback_days and hist:
                ...
                try:
                    ...
                    return None
                if oldest['date'] < today and age >= min_fallback_days:
                    return oldest
            return None
        def _prev_day():
