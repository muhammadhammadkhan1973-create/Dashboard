...
COT_HIST_DIAG = True   # PRE-ARMED one run: logs weeks-returned + computed index per contract; flip False after the runner confirms ~156 wks/contract
