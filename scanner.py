        ...
        for h in holdings:
            ...
            try:
                if src == 'ishares':
                    ...
                    _parts = []
                    _sfx = re.compile(r'^(Inc\.?|Ltd\.?|LLC|L\.?P\.?|Corp\.?|Co\.?|plc|PLC|S\.?A\.?|N\.?V\.?|AG|SE|SpA|Oyj|AB|ASA|KGaA|Bhd)$', re.I)
