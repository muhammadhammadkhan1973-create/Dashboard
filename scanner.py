...
def build_live_investment(data, existing):
    try:
        ...
        for h in holdings_cfg:
            ...
            ccy = (rec or {}).get('live_ccy') or 'USD'
            ytd = (rec or {}).get('live_ytd')
            r1y = (rec or {}).get('live_ret_1y')
            dchg = (rec or {}).get('daily_chg')
            sym = (rec or {}).get('live_sym')
