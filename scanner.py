        ...
        for tab, mkt, pmap, rows in feeds:
            for row in rows:
                ...
                if rec and rec.get('first_price'):
                    ...
                    rec['sector'] = row.get('sector', rec.get('sector', ''))
                else:
                    stocks[k] = {
