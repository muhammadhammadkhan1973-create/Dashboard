...
function im3CellHTML(ticker) {
  ...
  return `<div style="min-width:110px;cursor:pointer;" onclick="im3ToggleDetail('${ticker}')">
    <div style="display:flex;align-items:center;gap:6px;">
      ...
      <span style="font-family:var(--font-mono);font-size:12px;font-weight:700;" title="${r.is_bank?'Bank — scored on bank-applicable factors only (System B), NA excluded':'Scored on all 162 points'}">${r.score}/${r.max||162}</span>
...
function renderRecession(rec){
  ...
  var calRows=cal.length?cal.map(function(c){
