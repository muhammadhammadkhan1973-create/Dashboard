...
_FOREIGN_ANALYST_COLS = ['name', 'close', 'price_target_average', 'recommendation_mark',
                         ...
                         'Perf.YTD', 'Perf.Y', 'SMA50', 'SMA200']  # v1.214.1: live trend for the look-through underlyings (YTD/1Y + 50/200-DMA)
...
_LT_EXCH_NEWS = {'taiwan': 'Taiwan stock exchange TWSE market',
...
def build_live_lookthrough(data, existing):
    ...
    try:
        ...
        for h in holdings:
            ...
            for r in rows:
                mkt, tvsym = _lt_classify(r.get('ticker')) if r.get('ticker') else (None, None)
