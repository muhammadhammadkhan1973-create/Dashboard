...
def build_live_lookthrough(data, existing):
    ...
    try:
        ...
        pm = probe['by_market']
        log('  [Live Lookthrough] %d fund(s); holdings %d ok/%d miss; rated %d/%d; eps %d; news %d; markets %s'
            % (len(funds), probe['holdings_ok'], probe['holdings_miss'], probe['rated'],
               probe['rated'] + probe['unrated'], probe['eps'], probe['news'],
