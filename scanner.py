...
def main():
    ...
    try:
        ...
        # Wave PK-D: PSX PKR-devaluation alert (display/data-only multi-signal basket).
    try:
        data['psx_devaluation'] = _psx_m = (data.get('macros') or {}).get('psx') or {}; _psx_m['_history_ref'] = data.get('history') or []; compute_psx_devaluation(_psx_m)
