...
def build_m1_buylist(data, existing):
    ...
    today = dt.date.today()
    M1_SCORER_REV = 2   # bump when scoring semantics change; rev-mismatched carries re-score first
    _force = set()
    try:
