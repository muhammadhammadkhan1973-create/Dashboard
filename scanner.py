...
def _li_price_index(data):
    ...
    idx = {}
    for k in ('etf_momentum_watch', 'etf_hydrogen_watch', 'etf_emerging_themes_watch',
              'etf_metals_etc_watch', 'explosive_etf_tracker', 'tce_etf_tracker'):
...
def main():
    ...
    try:
        _live_disc = build_live_etf_discovery()
    except Exception as _e:
