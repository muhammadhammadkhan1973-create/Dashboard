...
def compute_cot_seasonality(metals, month=None):
    ...
    for metal in ('gold', 'silver', 'copper'):
        ...
        res['metals'][metal] = {
            'cot_pctile': pctile, 'cot_bias': cot_bias, 'cot_wow': wow,
...
def fetch_metals():
    ...
    try:
        ...
        for _m in ('gold', 'silver', 'copper'):
            ...
            _parts.append(f"{_m} {d['combined']} (COT {d['cot_bias']}/pctile {d['cot_pctile']}, seas {d['seasonal_bias']} {_sv})")
