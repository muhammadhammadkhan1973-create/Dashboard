...
def build_live_lookthrough(data, existing):
    ...
    try:
        ...
        data['live_lookthrough'] = {'as_of': _dt.date.today().isoformat(), 'funds': funds, 'probe': probe,
