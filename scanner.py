...
def fetch_psx_valuation_matrix():
    ...
    return {'by_ticker': by_ticker, 'sections': sections, 'as_of': as_of, 'quality_seed': seed}
    ...
    try:
        ...
        if _vm_last:
            try:
                ...
                _vm_age = None
        if _vm_age is not None and _vm_age < 7 and _prev_vm.get('by_ticker'):
