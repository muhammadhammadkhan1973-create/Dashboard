...
SCS_MSCI_INGEST = True
MSCI_DUMP_RAW = True  # FIRST-RUN armed: dump the runner's real pdfplumber text to lock the format; flip False once locked
...
def main():
    ...
    try:
        ...
        data['psx_msci'] = EXISTING.get('psx_msci', {})
