...
def build_live_investment(data, existing):
    try:
        ...
        for h in holdings_cfg:
            ...
            dchg = (rec or {}).get('daily_chg') if (rec or {}).get('daily_chg') is not None else (rec or {}).get('change')
